...
function fomartarSituacao(situacaoFinal) {
    ...
    switch(situacaoFinal){
        ...
        case 'Reprovado(a)': 
            ...
            console.log('adicionar class reporvado')
        break
...
function validarNumero(numero) {
    var num1 = cxNota1.value
    var num2 = cxNota2.value
...
btnCalcular.addEventListener('click', function(e){
    ...
    if(isNaN(media) || media < 0) {
        ...
        fomartarSituacao(situacaoFinal(media))
    }
    e.preventDefault()
})
